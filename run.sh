...
# python train_fix_l2ac.py --gpu 0 --ratio 2 --num_max 150 --imb_ratio_l 10 --imb_ratio_u 10  --epoch 500 --val-iteration 500 --out result/cifar100@N_150_r_10_10_fix_l2ac --dataset cifar100

# Run train_fix_l2ac.py on CIFAR-100 under gamma_l=20 and gramma_u=20
# python train_fix_l2ac.py --gpu 0 --ratio 2 --num_max 150 --imb_ratio_l 20 --imb_ratio_u 20  --epoch 500 --val-iteration 500 --out result/cifar100@N_150_r_20_20_fix_l2ac --dataset cifar100
